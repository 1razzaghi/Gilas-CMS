...
<?php echo $this->Form->create('GalleryItem'); ?>
	<fieldset>
		<legend><?php echo __('Edit Gallery Item'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('GalleryItem.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('GalleryItem.id'))); ?></li>
