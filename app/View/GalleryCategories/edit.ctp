...
<?php echo $this->Form->create('GalleryCategory'); ?>
	<fieldset>
		<legend><?php echo __('Edit Gallery Category'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('GalleryCategory.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('GalleryCategory.id'))); ?></li>
